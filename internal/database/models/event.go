...
type Event struct {
	...
	ChainName    string     `gorm:"column:chain_name;size:128;not null" json:"chain_name"`
	ChainVaultID uuid.UUID  `gorm:"column:chain_vault_id;type:char(36);not null" json:"chain_vault_id"`
