...
type Vault struct {
	...
	AccountID uuid.UUID `gorm:"column:account_id;type:char(36);not null;index:idx_vault_account_created" json:"account_id"`
	CreatedAt time.Time `gorm:"column:created_at;not null;index:idx_vault_account_created,sort:desc" json:"created_at"`
